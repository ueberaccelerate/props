...
namespace property
{
  ...
  public:
    holder() : holder_object{"int_value", "int_value_desc", "scalar", ObjectType::scalar, nullptr} { setup_scalar_holder(); }
...
public:                                                                                                                             \
  property::Scalar<param_type> param_name{#param_name, param_desc, property::deduce_prop_type_name<param_type>(#param_type).data(), \
                                          &this->holder_object};
