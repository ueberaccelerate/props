...
namespace property
{
  ...
  {
  public:
    virtual const char *what() const throw() override { return "serialize: empty serialize data error"; }
  };
  class size_serialize_error : public serialize_error
  {
  public:
    virtual const char *what() const throw() override { return "serialize: dismatch serialize data and class member"; }
  };
  ...
  {
  public:
    StackDeleter &operator()(T *) { return *this; }
  };
  struct SerializeNode
  {
    std::string name;
